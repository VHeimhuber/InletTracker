...
location_shp_fp = os.path.join(os.getcwd(), 'user_inputs', 'input_locations.shp')
...
settings = { 
    ...
    'use_fes_data': True,      # if the FES model was installed sucessfully, choose whether to include it in the analysis (True) or not (False). 
...
settings_entrance =  {   
    ...
    #include tide analysis    
    'tide_bool': settings['use_fes_data'] ,                   #include FES-based analysis of tides?
